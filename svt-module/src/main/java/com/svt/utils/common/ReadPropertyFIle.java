...
public class ReadPropertyFIle {
	...
	public Properties getPropConst() {
		...
		try {
//			input = new FileInputStream(constantsUtils.getFilepath() + File.separator + "SVT_MODULE.properties");
			input = new FileInputStream(constantsUtils.getFilepath() + File.separator + "LSM_API.properties");
			prop.load(input);
		} catch (Exception e) {
